!(function(t, e) {
  ...
  (function(t) {
    ...
    (t.remotipart = e = {
      ...
      teardown: function(t) {
        t.unbind("ajax:beforeSend.remotipart").removeData(
          "remotipartSubmitted"
        );
      }
    }),
            ...
            for (h = [], r = s = 0, c = e.length; s < c; r = ++s) {
              if (
                ...
                for (
                  ...
                  (l = i[a]),
                    l
                      .find(".contest-entry__list-box-img-wrap")
                      .css("height", d);
                i = [];
              }
        ...
        (Ht = function(t, e, i) {
          ...
          if (((n = void 0), t))
            if (t.forEach) t.forEach(e, i);
              ...
              for (n in t)
                (n = n), t.hasOwnProperty(n) && e.call(i, t[n], n, t);
        }),
        (Nt = function(e, i, n) {
          var o;
          return (
      ...
      switch (
        ...
        default:
          b.match(/^\/exhibitions\/\d+\/edit$/)
            ...
            : $(".user-show__content-wrap").length > 0 &&
              initUserImgUploaders();
      }
      return (
        (n = location.pathname),
        (m = $("#pagetop")),
